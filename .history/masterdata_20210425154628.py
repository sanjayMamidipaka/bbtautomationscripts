...
df1 = pd.DataFrame(index=[0,1,2],columns=timeprofile.columns) #adds 3 empty rows above 
masterdatafinal = df1.append(timeprofile, ignore_index=True) #re-adds column names under 4 empty rows
timeprofile.iloc[2] = column_names
