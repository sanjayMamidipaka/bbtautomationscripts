...
class timeprofile:
    ...
    def run(self):
        ...
        merge_format = workbook.add_format({'align': 'left', 'bold': True, 'color': 'red'})
        ...
        worksheet.merge_range(0, 0, 3, len(column_names)-1, 'Time Profile', workbook.add_format({'align': 'center', 'valign': 'vcenter', 'bold': True, 'color': 'red', 'font_size': 20}))
