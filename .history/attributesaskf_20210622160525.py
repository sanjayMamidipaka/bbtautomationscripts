...
class attributesaskf:
    ...
    def run(self):
        ...
        attributesaskf = pd.read_csv(self.paths[3], delimiter=';')
        ...
        worksheet.merge_range(0, 0, 3, len(column_names)-1, 'Attribute As Key Figure Definition', workbook.add_format({'align': 'center', 'valign': 'vcenter', 'bold': True, 'color': 'red',
        , 'font_size': 15}))
