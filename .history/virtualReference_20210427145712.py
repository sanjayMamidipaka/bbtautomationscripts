...
worksheet.merge_range(4, , 4, x_range_join_conditions, 'JOIN CONDITIONS', workbook.add_format({'align': 'center', 'valign': 'vcenter', 'bold': True, 'color': 'white', 'bg_color': 'orange'}))
