...
for i in range(len(keyfiguresbaseplanningid)):
    this1 = plevelsidanddescription.loc[plevelsidanddescription['Planning Level'] == keyfiguresbaseplanningid['Base Planning ID'][i],['Descrip']]
    #print(str(this1['Description']))
    keyfiguresfinal['Description'][i] = str(this1['Description'])
