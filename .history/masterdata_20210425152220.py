...
masterdatafinal['Decimal'] = np.nan
masterdatafinal['Check Attribute'] = np.nan
masterdatafinal['Check Master Data Type'] = np.nan
masterdatafinal['Attribute required for Virtual MD'] = np.nan
#print(masterdatatypes['Referenced Master Data Type'])
masterdatafinal['Referenced Master Data Type'] = masterdatatypes['Referenced Master Data Type']
masterdatafinal.to_excel("/Users/sanjaymamidipaka/Downloads/output.xlsx") 
