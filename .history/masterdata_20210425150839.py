...
masterdatafinal['Master Data Type'] = masterdatatypes['Type'] #A
masterdatafinal['Status IBP'] = 'Status IBP' #A
masterdatafinal['Master Data Components'] = masterdatatypes['Components'] #A
masterdatafinal['Master Data Type Name'] = masterdatatypes['Name'] #A
masterdatafinal['Master Data Type ID'] = masterdatatypes['Master Data Type ID'] #A 
masterdatafinal['Src MD'] = np.nan #A
