...
writer = pd.ExcelWriter('/Users/sanjaymamidipaka/Downloads/Energizer_2021-05-05_21_32_Production_output.xlsx', engine='xlsxwriter')
...
energizerlatestpaths = ['/Users/sanjaymamidipaka/Downloads/Energizer Latest/ZSAPIBP1C_MASTERDATATYPES_2021-05-05_23_32.csv',
        '/Users/sanjaymamidipaka/Downloads/Energizer Latest/ZSAPIBP1C_PLEVELS_ATTRS_2021-05-05_21_32.csv',
        '/Users/sanjaymamidipaka/Downloads/Energizer Latest/ZSAPIBP1C_KEYFIGURES_2021-05-05_21_32.csv',
        '/Users/sanjaymamidipaka/Downloads/Energizer Latest/ZSAPIBP1C_ATTRIBUTES_AS_KEYFIGURE_2021-05-05_21_32.csv',
        '/Users/sanjaymamidipaka/Downloads/Energizer Latest/ZSAPIBP1C_TIMEPROFILE_2021-05-05_21_32.csv',
        '/Users/sanjaymamidipaka/Downloads/Energizer Latest/ZSAPIBP1C_PA_ATTRIBUTES_2021-05-05_21_32.csv']
...
virtualReference_instance = virtualReference(writer, energizerproductionspaths)
virtualReference_instance.run()

attributes_instance = attributes(writer, energizerproductionspaths)
attributes_instance.run()

planninglevels_instance = planninglevels(writer, energizerproductionspaths)
planninglevels_instance.run()

keyfigures_instance = keyfigures(writer, energizerproductionspaths)
keyfigures_instance.run()

attributesaskf_instance = attributesaskf(writer, energizerproductionspaths)
