...
class masterdata:
    ...
    def run(self): #RENAME PLEVELS TO PA ATTRIBUTES
        #masterdatapath = '/Users/sanjaymamidipaka/Downloads/CFGSNA2_MASTERDATATYPES_2020-12-02_15_09.csv'
        #plevelspath = '/Users/sanjaymamidipaka/Downloads/CFGSNA2_PA_ATTRIBUTES_2020-12-02_15_09.csv'
        ...
        plevels = pd.read_csv(paattributespath, delimiter=';')
