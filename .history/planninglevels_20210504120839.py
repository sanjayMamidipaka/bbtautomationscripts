...
planninglevelsfinal['Planning Level'] = planninglevels['Description'] #A
planninglevelsfinal['Source Master Data Type'] = planninglevels['Master Data Type ID']


print(planninglevels.columns)
