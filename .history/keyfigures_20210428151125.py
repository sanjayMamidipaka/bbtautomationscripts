...
keyfiguresfinal['Base Planning Description'] = merged_description['Description']
keyfiguresfinal['Key Figure Name'] = keyfigures['Name']
keyfiguresfinal['Key Figure Name']
