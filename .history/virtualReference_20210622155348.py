...
class virtualReference:
    ...
    def run(self):
        ...
        worksheet.merge_range(4, x_range_referenced_attributes+1, 4, x_range_join_conditions, 'JOIN CONDITIONS', workbook.add_format({'align': 'center', 'valign': 'vcenter', 'bold': True, 'color': 'red', 'bg_color': 'orange'}))
