...
#Vlookups
keyfiguresLeftColumn = pd.DataFrame(keyfiguresfinal['Base Planning ID'], columns=['Base Planning ID'])
planningLevelsRightColumns = plevels[['Planning Level', 'Description']]
pd.merge(keyfiguresLeftColumn, planningLevelsRightColumns, how='left', on=['Base Planning ID', 'Planning Level'])
