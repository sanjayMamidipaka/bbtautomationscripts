...
timeprofile = pd.read_csv('/Users/sanjaymamidipaka/Downloads/csv_files/CFGSNA2_TIMEPROFILE_2020-12-02_15_09(1).csv', delimiter=';')
...
writer = pd.ExcelWriter('/Users/sanjaymamidipaka/Downloads/timeprofile_goal_output(1).xlsx', engine='xlsxwriter')
