...
keyfiguresbaseplanningid = pd.DataFrame(list(keyfiguresfinal['Base Planning ID']), columns=['Planning Level'])
print(plevelsidanddescription, keyfiguresbaseplanningid)
#pd.merge()
