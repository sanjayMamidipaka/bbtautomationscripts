...
class masterdata:
    ...
    def run(self): #RENAME paattributes TO PA ATTRIBUTES
        #masterdatapath = '/Users/sanjaymamidipaka/Downloads/CFGSNA2_MASTERDATATYPES_2020-12-02_15_09.csv'
        #paattributespath = '/Users/sanjaymamidipaka/Downloads/CFGSNA2_PA_ATTRIBUTES_2020-12-02_15_09.csv'
        ...
        paattributespath = '/Users/sanjaymamidipaka/Downloads/Energizer Production_ZSAPIBP1C_2021-05-04_21_01/ZSAPIBP1C_PA_ATTRIBUTES_2021-05-04_21_01.csv'
        ...
        # masterdatapath = '/Users/sanjaymamidipaka/Downloads/ZSAPIBP1C_MASTERDATATYPES_2021-04-16_15_02.csv'
        # paattributespath = '/Users/sanjaymamidipaka/Downloads/ZSAPIBP1C_PA_ATTRIBUTES_2021-04-16_15_02.csv'

        masterdatatypes = pd.read_csv(masterdatapath, delimiter=';')
        paattributes = pd.read_csv(paattributespath, delimiter=';')
        ...
        attributeidmasterdata = masterdatafinal['Attribute ID'] #just the attribute id
        extracolumnspaattributes = paattributes[['Attribute ID','Business Meaning','Attribute Category',]]
