...
for i in range(len(keyfiguresbaseplanningid)):
    keyfiguresfinal['Description'][i] = keyfiguresbaseplanningid['Planning Level'][i], plevelsidanddescription.loc[plevelsidanddescription['Planning Level'] == keyfiguresbaseplanningid['Planning Level'][i]]
