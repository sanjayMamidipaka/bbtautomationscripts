...
x_range_referenced+attributes
worksheet.merge_range(4, 0, 4, 5, 'REFERENCED ATTRIBUTES', workbook.add_format({'align': 'center', 'valign': 'vcenter', 'bold': True, 'color': 'white', 'bg_color': 'red'}))

#merge 'join conditions' heading
worksheet.merge_range(4, 6, 4, 10, 'JOIN CONDITIONS', workbook.add_format({'align': 'center', 'valign': 'vcenter', 'bold': True, 'color': 'white', 'bg_color': 'orange'}))

#change format of 'comments' cell
worksheet.write(4, 11, '', workbook.add_format({'bold': True, 'color': 'white', 'bg_color': 'red'}))
worksheet.write(5, 11, 'Comment', workbook.add_format({'bold': True, 'color': 'white', 'bg_color': 'red'}))

#change colums colors/formatting
for i in range(5)
