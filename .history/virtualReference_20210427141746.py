...
masterdatafinal['Master data type'] = np.nan #H
masterdatafinal['Master data type'] = np.nan #I
masterdatafinal['Master data type'] = np.nan #J
masterdatafinal['Master data type'] = np.nan #K
