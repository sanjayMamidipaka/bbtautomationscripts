...
for i in range(len(keyfiguresbaseplanningid)):
    keyfiguresbaseplanningid['Planning Level'][i], plevelsidanddescription.loc[plevelsidanddescription['Planning Level'] == keyfiguresbaseplanningid['Planning Level'][i]])
