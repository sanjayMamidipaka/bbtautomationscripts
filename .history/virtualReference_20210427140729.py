...
masterdatafinal['Attribute'] = masterdatatypes['Attribute ID']
masterdatafinal['Referenced Master data type'] = masterdatatypes['Master Data Type ID']
masterdatafinal['Referenced Attribute'] = masterdatatypes
print(masterdatafinal.head(5))